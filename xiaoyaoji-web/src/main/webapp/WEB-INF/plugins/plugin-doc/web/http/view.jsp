...
<span class="doc-update-time">更新时间: <span id="api-update-time">{{doc.lastUpdateTime}}</span></span>
    <div id="api-details" class="api-details">
        ...
        <div class="doc-item-section" v-if="content.description" id="doc-desc">
            <p class="doc-item-section-title">接口描述</p>
            <div v-html="content.description"></div>
        </div>
        <div v-if="(global.http.requestHeaders&&global.http.requestHeaders.length>0 && !content.ignoreGHttpReqHeaders)" id="doc-g-req-header">
        ...
        <div v-if=" (global.http.requestArgs  && global.http.requestArgs.length>0 && !content.ignoreGHttpReqArgs)" id="doc-g-req-args">
        ...
        <div v-if="(global.http.responseHeaders&&global.http.responseHeaders.length>0 && !content.ignoreGHttpRespHeaders)" id="doc-g-resp-header">
        ...
        <div v-if="(global.http.responseArgs  && global.http.responseArgs.length>0 && !content.ignoreGHttpRespArgs)" id="doc-global-resp-args">
        ...
        <div v-if="(content.requestHeaders  && content.requestHeaders.length>0)" id="doc-request-header">
        ...
        <div v-if=" (content.requestArgs  && content.requestArgs.length>0)" id="doc-request-args">
        ...
        <div v-if="(content.requestHeaders  && content.requestHeaders.length>0)" id="doc-response-header">
         ...
         <div v-if="content.responseArgs && content.responseArgs.length>0" id="doc-response-args">
                        ...
                        <div class="col-sm-8">
                            <div v-if="!hasXyjPlugin">
                                ...
                                <input type="button" data-ignore v-on:click.stop="localSubmit"
                                       class="btn btn-primary" :value="apiLoading?'加载中':'提交'">
                            </div>
                            <div v-if="hasXyjPlugin">
