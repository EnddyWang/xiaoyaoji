requirejs(['utils', 'vue',
    xyj.cdn + '/assets/jsonformat/jsonFormater.js',
    xyj.cdn + '/assets/clipboard/clipboard.min.js',
    xyj.ctx+'/proxy/'+pluginId + '/assets/js/chrome-extension.js',
    xyj.cdn + '/assets/ace/src-min/ace.js',
    xyj.cdn + '/assets/xml2json/2json.js',
    xyj.cdn + '/assets/xml2json/2xml.js'
    ...
    function Result() {
        var jf = new JsonFormater({
            dom: '#api-result',
            imgCollapsed: xyj.cdn+'/assets/jsonformat/images/Collapsed.gif',
            imgExpanded: xyj.cdn+'/assets/jsonformat/images/Expanded.gif'
        });
        var fn = {
            JSON: function (data) {
                try {
    ...
    new Vue({
        ...
        created: function () {
            ...
            var temp = localStorage.getItem(xyj.page.projectId+"_currentEnv");
            if(temp){
        ...
        methods: {
            ...
            changeEnv:function(item){
                ...
                localStorage.setItem(xyj.page.projectId+"_currentEnv",JSON.stringify(item))
            }
        }
    });
