...
<script type="text/template" id="response-headers-template" class="hide">
    <div v-bind:class="{'div-editing-table':editing,'response-headers':true}" class="placeholder-response-headers"
        ...
        <div class="div-table-line " v-bind:class="{'div-editing-line':editing}" v-for="item in responseHeaders"
            ...
            <div v-if="editing">
                <ul class="cb">
                    ...
                    <li class="col-sm-3 input"><input type="text" list="headerlist" class="text name"
            ...
            <div class="sub">
                <response-headers-vue v-bind:request-headers.sync="item.children"
...
<script>
    requirejs(['vue', '${ctx}/plugin/assets/${pluginInfo.id}/js/table.js?v=${pluginInfo.version}'], function (Vue, table) {
