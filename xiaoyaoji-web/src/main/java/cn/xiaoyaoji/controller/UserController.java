...
import cn.xiaoyaoji.data.bean.FindPassword;
import cn.xiaoyaoji.data.bean.Thirdparty;
import cn.xiaoyaoji.data.bean.User;
import cn.xiaoyaoji.extension.email.EMailUtils;
...
import cn.xiaoyaoji.service.UserService;
...
public class UserController {
     ...
     */
    @PostMapping()
    public Object update(User user, cn.xiaoyaoji.service.domain.User updateUser,
    ...
    public Object create(cn.xiaoyaoji.service.domain.User user) {
